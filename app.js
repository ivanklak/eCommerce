  ...
  getbagButtons() {
    ...
    buttons.forEach(button => {
      ...
      button.addEventListener("click", event => {
        ...
        cart = [...cart, cartItem];
        //console.log(cart) - получаем массив с объектами. Объект - product.
        // С каждым кликом "Add to bag" мы получаем новый массив с прежним продуктом и новым
